...
const HEALTH_TIPS = [
    "Caminhar 30 minutos por dia ajuda no controle da pressão arterial.",
    "Dormir bem também faz parte da saúde do coração.",
    "Reduzir o excesso de sal pode ajudar no controle da hipertensão.",
    "Beber água regularmente é importante para o organismo.",
    "O estresse pode influenciar na pressão arterial.",
    "Pequenas mudanças diárias geram grandes resultados ao longo do tempo.",
    "Evite interromper medicamentos sem orientação médica.",
    "Frutas e verduras fazem bem para o coração.",
    "Manter uma rotina ajuda no controle da saúde.",
    "O acompanhamento médico regular é essencial.",
    "Exercícios leves já podem trazer benefícios cardiovasculares.",
    "Evite fumar. O cigarro prejudica vasos e coração.",
    "Pressão alta muitas vezes não apresenta sintomas.",
    "Registrar as aferições ajuda no acompanhamento da evolução.",
    "Reduzir alimentos ultraprocessados pode beneficiar a saúde cardiovascular.",
    "Alongamentos ajudam no bem-estar e relaxamento corporal.",
    "O excesso de álcool pode impactar a pressão arterial.",
    "Ter momentos de descanso durante o dia faz diferença.",
    "Respirações profundas ajudam a reduzir tensão momentânea.",
    "Consulte profissionais de saúde regularmente.",
    "O coração também sente os impactos da ansiedade.",
    "Dormir e acordar em horários regulares ajuda o organismo.",
    "Alimentação equilibrada é aliada da saúde cardiovascular.",
    "Evite excesso de refrigerantes e bebidas açucaradas.",
    "Monitorar a pressão é um hábito importante.",
    "Cuide da saúde mesmo quando estiver se sentindo bem.",
    "O sedentarismo pode aumentar riscos cardiovasculares.",
    "Fazer exames periódicos ajuda na prevenção.",
    "Comer devagar ajuda na digestão e bem-estar.",
    "O apoio da família faz diferença no cuidado com a saúde.",
    "Reduzir o estresse diário pode ajudar na qualidade de vida.",
    "Pequenas caminhadas após refeições podem ser benéficas.",
    "A constância é mais importante que a perfeição.",
    "Evite excesso de alimentos muito salgados.",
    "A saúde do coração merece atenção diária.",
    "Uma rotina saudável começa aos poucos.",
    "O acompanhamento da pressão ajuda na tomada de decisões médicas.",
    "Sentir tontura frequente merece avaliação profissional.",
    "O cuidado preventivo é sempre importante.",
    "O excesso de peso pode impactar a pressão arterial.",
    "O descanso adequado ajuda o corpo a funcionar melhor.",
    "Controlar a pressão ajuda a reduzir riscos futuros.",
    "O corpo dá sinais. Observe como você se sente.",
    "Exercícios devem respeitar seus limites e orientação profissional.",
    "Ter uma rotina de aferição ajuda no acompanhamento médico.",
    "Evite exageros alimentares frequentes.",
    "O cuidado diário vale mais que mudanças radicais temporárias.",
    "A saúde cardiovascular envolve hábitos contínuos.",
    "A prática regular de atividades físicas pode trazer benefícios.",
    "O acompanhamento familiar pode ajudar no tratamento.",
    "Consulte sempre fontes confiáveis sobre saúde.",
    "O coração trabalha sem parar. Cuide bem dele.",
    "Uma boa alimentação beneficia todo o organismo.",
    "Mudanças graduais costumam ser mais sustentáveis.",
    "Cuidar da saúde hoje é investir no futuro.",
    "Evite automedicação.",
    "Manter registros organizados facilita consultas médicas.",
    "A prevenção é uma grande aliada da saúde.",
    "A pressão arterial pode variar ao longo do dia.",
    "Pequenos hábitos saudáveis fazem diferença ao longo da vida."
];
